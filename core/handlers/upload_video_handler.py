...
async def send_video_handler(bot, cmd, output_vid, video_thumbnail, duration, width, height, editable, logs_msg, file_size):
    ...
    sent_vid = await bot.send_video(
        ...
        reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Developer", url="https://t.me/TheOnlyMrLucifer")],
                                           [InlineKeyboardButton("PRN Channel", url="https://t.me/Plus18PRNO")],
                                           [InlineKeyboardButton("18+ Group", url="http://t.me/PeriOFiGPeeksTango")]]),
