...
async def HelpWatermark(bot, cmd):
	...
	await cmd.reply_text(
		...
		parse_mode="Markdown",
		reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Developer", url="https://t.me/TheOnlyMrLucifer"), InlineKeyboardButton("18+ Group", url="http://t.me/PeriOFiGPeeksTango")], [InlineKeyboardButton("PRN Group", url="https://t.me/Plus18PRNO")], [InlineKeyboardButton("Source Code", url="https://github.com/TheOnlyMrLucifer/LuciferWaterMark")]]),
...
async def button(bot, cmd: CallbackQuery):
	...
	if "refreshmeh" in cb_data:
			...
			try:
				...
				if user.status == "kicked":
					await cmd.message.edit(
						text="Sorry Sir, You are Banned to use me. Contact my [18+ Group](http://t.me/PeriOFiGPeeksTango).",
						parse_mode="markdown",
						disable_web_page_preview=True
					)
					return
				...
				await cmd.message.edit(
					text="**You Still Didn't Join ☹️, Please Join My 18+ Channel to use this Bot!**\n\nDue to Overload, Only Channel Subscribers can use the Bot!",
					reply_markup=InlineKeyboardMarkup(
						[
							[
				...
				await cmd.message.edit(
					text="Something went Wrong. Contact my [18+ Group](http://t.me/PeriOFiGPeeksTango).",
					parse_mode="markdown",
					disable_web_page_preview=True
				)
				return
		await cmd.message.edit(
			text=Config.USAGE_WATERMARK_ADDER,
			parse_mode="Markdown",
			reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Developer", url="https://t.me/TheOnlyMrLucifer"), InlineKeyboardButton("18+ Group", url="http://t.me/PeriOFiGPeeksTango")], [InlineKeyboardButton("PRN Group", url="https://t.me/Plus18PRNO")]]),
			disable_web_page_preview=True
		)
			...
			try:
				...
				await cmd.message.edit(
					...
					reply_markup=InlineKeyboardMarkup(
						[
							[
								InlineKeyboardButton("🤖 Join 18+ Channel", url=invite_link.invite_link)
							],
							[
								InlineKeyboardButton("🔄 Refresh 🔄", callback_data="refreshmeh")
							]
